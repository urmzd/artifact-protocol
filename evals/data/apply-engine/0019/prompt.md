# Case 0019: html-dashboard — dashboard for server monitoring

**Model:** `gemma4` | **Format:** `text/html`

**Sections expected:** `nav`, `stats`, `content`, `footer`
**Sections found:** `nav`, `stats`, `content`
...
```
Create a self-contained HTML dashboard with inline CSS dashboard for server monitoring.
